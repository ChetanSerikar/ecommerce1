    ...
    <>
      ...
      <div className={`cart-div ${cart ? "open-cart" : "closed-cart"}`}>
        <div className="cart-title-btn">
          <h2 className="cart-full-h2">Your Shopping Cart ({cartQuantity})</h2>
        ...
        <div className="container-1">
          <div className={`nav-container ${sticky ? "cont-sticky" : ""}`}>
            ...
            <div className="nav-links">
              ...
              <Link onClick={() => window.scrollTo(0, 0)} to="/productpage/1">
                product page
              </Link>
              <i
                data-array-length={cartQuantity}
                onClick={openCart}
                className={`${
                  cartQuantity < 1 ? "cart-icon" : "cart-icon with-items"
                }`}
              >
                <IconShoppingCart />
              </i>
